...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9.mb-md-0.order-lg-1.order-2(data-aos="fade-right")
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-3.col-md-5.col-6.mb-lg-0.mb-4(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema1/img03.png', alt='Imagen decorativa')
      .col-lg-9.mb-md-0.mb-lg-0.mb-4(data-aos="fade-left")
    ...
    .bloque-texto-g.bloque-texto-g--inverso.color1.p-3.p-sm-4.p-md-5.mb-0
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema1/img07.png')})`}" data-aos="fade-left"
      )
    ...
    .tarjeta.tarjeta--BG02.px-md-5.px-4.py-4
      .row.justify-content-center
        .col-lg-3.d-none.d-lg-block(data-aos="fade-right")
          figure(data-aos="zoom-in")
            img(src="@/assets/curso/temas/tema1/img08.png", alt="Imagen decorativa").img400.m-auto
        .col-lg-9(data-aos="fade-left")
          SlyderF.color-acento-botones(columnas="col-lg-6 col-xl-4")
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img09.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img10.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img11.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img12.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img13.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img14.svg", alt="Imagen decorativa").img100.m-auto
            ...
            .tarjeta.tarjeta--slyder.p-4
              .row.justify-content-center.mb-4
                .col-6.col-lg-8
                  img(src="@/assets/curso/temas/tema1/img15.svg", alt="Imagen decorativa").img100.m-auto
    ...
    .row.justify-content-center.mb-4
      .col-lg-7(data-aos="fade-right")
        LineaTiempoD.color-acento-botones
          div(numero="1" titulo="Ciberespacio público")
            p.mb-0 Comprende las áreas de Internet de libre acceso para todos los usuarios, como sitios <em>web</em> informativos, redes sociales abiertas y foros públicos. Es un espacio de intercambio global donde la información circula sin restricciones significativas.
          div(numero="2" titulo="Ciberespacio privado")
            p.mb-0 Incluye redes digitales con acceso restringido, como sistemas internos de empresas, correos electrónicos corporativos y plataformas bancarias. La seguridad y la privacidad son esenciales en este entorno.
          div(numero="3" titulo="Ciberespacio comercial")
            p.mb-0 Se centra en las actividades económicas y el comercio digital, abarcando tiendas en línea, plataformas de pago electrónico y servicios de suscripción. Su expansión ha transformado la forma en que se realizan transacciones a nivel global.
          div(numero="4" titulo="Ciberespacio gubernamental")
            p.mb-0 Utilizado por entidades estatales para gestionar bases de datos oficiales, ofrecer servicios públicos y facilitar la comunicación con la ciudadanía. Su objetivo es optimizar la administración electrónica y garantizar la transparencia.
          div(numero="5" titulo="Ciberespacio militar o estratégico")
            p.mb-0 Comprende la infraestructura digital utilizada para la defensa, la inteligencia y la seguridad nacional. Incluye sistemas de vigilancia, redes de comunicación militar y plataformas de ciberdefensa.
          div(numero="6" titulo="Ciberespacio educativo")
            p.mb-0 Espacio destinado a la educación y la capacitación a través de plataformas de aprendizaje en línea, repositorios académicos y entornos virtuales. Su relevancia ha aumentado con la digitalización de la enseñanza.
          div(numero="7" titulo="Ciberespacio criminal")
            p.mb-0 Incluye redes clandestinas y foros utilizados para actividades ilícitas, como el tráfico de datos, la ciberdelincuencia y los ataques informáticos. El "<em>dark web</em>" es un ejemplo representativo de este tipo de ciberespacio.
